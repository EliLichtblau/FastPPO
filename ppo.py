...
from env import MultiEnvRotatorWorld, RotatorWorld, MultiRotatorEnvironment
from typing import Optional, List, Union, Any, Type, Tuple, Dict

from stable_baselines3.common.type_aliases import Schedule
from stable_baselines3.common.utils import get_schedule_fn
from buffers import RolloutBufferGPU
...
env = RotatorEnvironment()
#multi_env = MultiRotatorEnvironment(5, 1, 17)
lr_schedule = get_schedule_fn(0.1)
policy = ActorCriticPolicy(env.observation_space, env.action_space, lr_schedule)
